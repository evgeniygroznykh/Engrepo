...
def isReportingPeriodSet():
    return request.form['sortStartTime'] and request.form['sortEndTime']

def isFilterButtonPressed():
    return 'filter_button' in request.form

def isDownloadButtonPressed():
    return 'download_button' in request.form
